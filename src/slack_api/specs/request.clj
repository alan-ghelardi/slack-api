(ns
 ...
 "Auto-generated specs for Slack's requests. Do not modify this file manually."
...
(s/def
 :slack.channels.set-purpose/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload
...
(s/def :slack.chat.delete-scheduled-message/req (s/schema {}))

(s/def
 :slack.chat.get-permalink/req
 (s/schema
  #:slack.req{:query
              (s/schema
               {:token string?,
...
(s/def
 :slack.chat.me-message/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload (s/schema {:text string?, :channel string?})}))

(s/def
 :slack.chat.post-ephemeral/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload
              (s/schema
...
(s/def
 :slack.chat.schedule-message/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload
              (s/schema
...
(s/def
 :slack.chat.scheduled-messages.list/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :query
              (s/schema
...
(s/def
 :slack.conversations.set-purpose/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload
              (s/schema {:purpose string?, :channel string?})}))
...
(s/def
 :slack.conversations.set-topic/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload (s/schema {:topic string?, :channel string?})}))
...
(s/def :slack.dnd.end-dnd/req (s/schema {}))

(s/def :slack.dnd.end-snooze/req (s/schema {}))
...
(s/def :slack.dnd.set-snooze/req (s/schema {}))

(s/def
 :slack.dnd.team-info/req
 (s/schema
...
(s/def
 :slack.files.revoke-public-url/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload (s/schema {:file string?})}))

(s/def
 :slack.files.shared-public-url/req
 (s/schema
  #:slack.req{:headers (s/schema {:token string?}),
              :payload (s/schema {:file string?})}))
...
(s/def :slack.team.billable-info/req (s/schema {}))
...
(s/def
 :slack.team.integration-logs/req
 (s/schema
  #:slack.req{:query
              (s/schema
               {:count string?,
...
(s/def
 :slack.users.delete-photo/req
 (s/schema #:slack.req{:payload (s/schema {:token string?})}))

(s/def
 :slack.users.get-presence/req
 (s/schema
  #:slack.req{:query (s/schema {:token string?, :user string?})}))
...
(s/def
 :slack.users.lookup-by-email/req
 (s/schema
...
(s/def
 :slack.users.set-active/req
 (s/schema #:slack.req{:headers (s/schema {:token string?})}))

(s/def
 :slack.users.set-photo/req
 (s/schema
  #:slack.req{:payload
              (s/schema
               {:image string?,
